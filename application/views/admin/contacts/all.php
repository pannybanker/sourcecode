							...
							<div class="col-md-12">
								<div class="panel_s events animated fadeIn">
									...
									<div class="row">
                                        ...
                                        <table id="dtContacts" style="width: 100%; ">
                                        <thead>
                                        <tr>
                                        <th>Name</th>
                                        <th>Designation</th>
                                       ...
                                       $resun=$this->db->get_where('contact',array('visited'=>'0'))->result_array(); 
                                      ...
                                      foreach($resun as $rs){
                                          ...
                                          echo "<tr><td>".$rs['contact_fname'].' '.$rs['contact_lname']."</td>"
                                          ."<td>".$rs['contact_position']."</td>"
                                          ."<td>".$rs['contact_email']."</td>"
                                          ."<td>".$rs['contact_phone']."</td>"
                                          ."<td>".date('m-d-Y H:i',strtotime($rs['contact_date']))."</td>"
                                          ."<td>View</td></tr>";
								...
								<div class="col-md-6 hide">
									<div class="panel_s animated fadeIn">
										<div class="panel-body todo-body">
											<h4 class="todo-title warning-bg"><i class="fa fa-check"></i>
												<?php echo "Old Messages"; ?></h4>
