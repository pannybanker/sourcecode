               ...
               <div class="panel-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-2 text-right">
                        <a href="<?php echo admin_url('expenses/delete_expense_attachment/'.$expense->expenseid); ?>" class="text-danger"><i class="fa fa fa-times"></i></a>
                     </div>
                  </div>
                  <hr />
                  <?php } ?>
                  ...
                  <?php echo render_select('clientid',$customers,array('userid','company'),'expense_add_edit_customer',$selected); ?>
                  <?php
                     $_hide = 'hide';
                     if(!isset($expense) ){
                         $_hide = 'hide';
