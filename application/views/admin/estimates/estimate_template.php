      ...
      <div class="row">
         <div class="col-md-12">
            <div class="single-option-buttons">
               <button type="submit" class="btn btn-info mleft10 text-right pull-right">
               <?php echo _l('submit'); ?>
               </button>
            </div>
         </div>
         <div class="col-md-6 border-right">
            ...
            <?php echo render_select('clientid',$clients,array('userid','company'),'estimate_select_customer',$selected); ?>
            <div class="row">
               <div class="col-md-12">
         ...
         <div class="col-md-9 text-right">
            <div class="mtop10">
               ...
               <div class="radio radio-primary radio-inline">
                  <input type="radio" value="1" name="show_quantity_as" data-text="<?php echo _l('estimate_table_quantity_heading'); ?>" <?php if(isset($estimate) && $estimate->show_quantity_as == 1){echo 'checked';}else{echo'checked';} ?>>
                  <label for="<?php echo _l('quantity_as_qty'); ?>"><?php echo _l('quantity_as_qty'); ?></label>
               </div>
               <div class="radio radio-primary radio-inline">
                  <input type="radio" value="2" name="show_quantity_as" data-text="<?php echo _l('estimate_table_hours_heading'); ?>" <?php if(isset($estimate) && $estimate->show_quantity_as == 2){echo 'checked';} ?>>
                  <label for="<?php echo _l('quantity_as_hours'); ?>"><?php echo _l('quantity_as_hours'); ?></label>
               </div>
               <div class="radio radio-primary radio-inline">
                  <input type="radio" value="3" name="show_quantity_as" data-text="<?php echo _l('estimate_table_quantity_heading'); ?>/<?php echo _l('estimate_table_hours_heading'); ?>" <?php if(isset($estimate) && $estimate->show_quantity_as == 3){echo 'checked';} ?>>
                  <label for="<?php echo _l('quantity_as_hours'); ?>"><?php echo _l('estimate_table_quantity_heading'); ?>/<?php echo _l('estimate_table_hours_heading'); ?></label>
               </div>
            </div>
         </div>
      </div>
