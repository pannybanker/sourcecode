    <div class="panel_s">
      <div class="panel-body">
        <h4 class="bold no-margin"><?php echo _l('proposals'); ?></h4>
      </div>
    </div>
    <div class="panel_s">
      <div class="panel-body">
          ...
          <table class="table dt-table">
            ...
            <tbody>
              ...
              <tr>
               ...
               <td><?php echo _d($proposal['open_till']); ?></td>
               <td><?php echo _d($proposal['date']); ?></td>
               <td><?php echo format_proposal_status($proposal['status']); ?></td>
               <?php foreach($custom_fields as $field){ ?>
               <td><?php echo get_custom_field_value($proposal['rel_id'],$field['id'],'proposal'); ?></td>
               <?php } ?>
             </tr>
             <?php } ?>
           </tbody>
