           ...
           //echo "<pre>"; print_r($news_array);
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <article class="row inner-page-bannerHolder no-gutters">
                                    ...
                                    if ($j==0) {
                                            ...
                                            if (!empty($headers)) {
                                                if (!in_array('Server: cloudflare-nginx', $headers)) {
                                                    ...
                                                    ?>
                                                    <div class="col-sm-8 no-padding" style="background: #333;">
                                                        <div class="inner-banner">
                                                            <img src="<?php echo $value->main_image; ?>" style="height: 350px;" id="img_topn"
                    ...
                    <div class="col-sm-4 no-padding" style="height: 350px;">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 no-padding">
               ...
               // echo "<pre>";print_r($scroll_news);echo "</pre>";
                ...
                <article class="headline-container">    
                    ...
                    <?php if (!empty($news_array->$kk)) {
                    $s = shuffle($news_array->$kk);
                    ...
                    <div class="col-xs-12">
                        <div id="products" class="row list-group">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <?php foreach ($news_array->$kk as $value) {
                                if($cunt < 13){ ?>
                                <div class="item col-sm-6 col-md-4">
                                    <div class="thumbnail">
                                        <img class="group list-group-image" style="height:150px;" src="<?php echo $value->main_image; ?>"
                                             alt=""/>
                                        <div class="caption">
                                            <ul class="hgpm-meta">
                                                <li><span
