   ...
   <div class="panel-body">
      <div class="row">
         ...
         <div class="col-md-9 text-right">
            ...
            <a href="<?php echo admin_url('proposals/pdf/'.$proposal->id.'?print=true'); ?>" target="_blank" class="btn btn-default mright5" data-toggle="tooltip" title="<?php echo _l('print'); ?>" data-placement="bottom"><i class="fa fa-print"></i></a>
