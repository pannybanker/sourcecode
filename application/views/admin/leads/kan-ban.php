                              ...
                              <div class="panel-body lead-body<?php if(total_rows('tblclients',array('leadid'=>$lead['id'])) > 0){echo ' not-sortable';} ?>">
                                <div class="row">
                                 <div class="col-md-12 lead-name">
                                   <a href="#" onclick="init_lead(<?php echo $lead['id']; ?>);return false;"><h5 class="bold"><?php echo $lead['name']; ?></h5></a>
                                 </div>
                                 ...
                                 <div class="col-md-6 text-right text-muted">
                                   ...
                                   <small><i class="fa fa-paperclip"></i> <?php echo _l('leads_canban_notes', total_rows('tblleadnotes', array(
                                    ...
                                    <br />
                                    <small><i class="fa fa-files-o"></i> <?php echo _l('lead_kan_ban_attachments', total_rows('tblleadattachments', array(
                                    'leadid' => $lead['id']
                                    ))); ?></small>
                                  </div>
                                  <?php
