...
$route['users/savedata']  = "users/index_dashboard";
$route['users/income-donloadpdf']  = "users/income_donloadpdf";
$route['users/expenses-donloadpdf']  = "users/expenses_donloadpdf";
