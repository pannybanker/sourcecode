...
<h4 class="bold"><?php echo _l('task_checklist_items'); ?></h4>
<?php } ?>
...
if(count($view_task->comments) > 0){
  ...
  <div class="mbot10 mtop10" data-commentid="<?php echo $comment['id']; ?>">
    ...
    <?php echo staff_profile_image($comment['staffid'], array(
      ...
      <?php } else { ?>
      <img src="<?php echo client_profile_image_url($comment['clientid']); ?>" class="client-profile-image-small media-object img-circle pull-left mright10">
      <?php } ?>
      <div class="media-body">
        ...
        <span class="pull-left bold">
          <?php echo get_client_full_name($comment['clientid']); ?></span>
          <br />
          <?php } ?>
          <?php if($comment['clientid'] != 0){ ?>
          <?php
          ...
          <?php } ?>
          <?php } ?>
          <div class="comment-content" data-comment-content="<?php echo $comment['id'] ;?>"><?php echo check_for_links($comment['content']); ?></div><br />
      ...
      if($project->settings->comment_on_tasks == 1){
        ...
        <div class="col-md-12">
          ...
          <button type="submit" class="btn btn-info mtop10 pull-right"><?php echo _l('task_single_add_new_comment'); ?></button>
