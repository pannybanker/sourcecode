                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 product_img">
                            ...
                            <img src="" id="spnNImage" class="img-responsive" style="height: 300px;width:100%;">
...
&nbsp;&nbsp;
                        ...
                        <div class="col-md-4 tgext-center">
                            <h5 style="color: rgb(24, 119, 182) !important;">Advertisements</h5>
                            <hr>
                            ...
                            <nav class="navbar">
                                ...
                                <div class="collapse navbar-collapse js-navbar-collapse top-nav">
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'economics') {
                                            echo ' active';
                                        }
                                        ?> ">
                                            <?php if($this->router->method !='' || $this->router->method=="news"){ ?>
                                            <a href="<?php echo base_url(); ?>world/news/economics">Economy</a>
                                            <?php } ?>

                                        </li>
                                        <li class="site-nav-theme-border business-theme-bg <?php
                                        if ($this->router->class === 'world' && $this->uri->segment(3)=== 'business') {
                                            echo ' active';
                                        }
                                        ?> ">
                                            <?php if($this->router->method !='' || $this->router->method=="news"){ ?>
                                        ...
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'tech') {
                                            echo ' active';
                                        }
                                        ?> ">
                                            <?php if($this->router->method !='' || $this->router->method=="news"){ ?>
                                        ...
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'market') {
                                            echo ' active';
                                        }
                                        ?> ">
                                            <?php if($this->router->method !='' || $this->router->method=="news"){ ?>
                                        ...
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'art_life') {
                                            echo ' active';
                                        }
                                        ?> ">
                                            <?php if($this->router->method !='' || $this->router->method=="news"){ ?>
                                        ...
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'real_estate') {
                                            echo ' active';
                                        }
                                        ?> ">
                                            <?php if($this->router->method !='' || $this->router->method=="news"){ ?>
                                        ...
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'sports') {
                                            echo ' active';
                                        }
                                        ?> ">
                                            <?php if($this->router->method !='' || $this->router->method=="news"){ ?>
                                        ...
                                        <li class="<?php
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'weather') {
                                            echo ' active';
                                        }
                                        ...
                                        <li class="<?php
                                        if ($this->router->class === 'world' && $this->uri->segment(3) === 'traffic') {
                                            echo ' active';
                                        }
